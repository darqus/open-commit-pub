...
const translations = {
    ru: {
        statusBarGenerating: '$(sync~spin) Open Commit генерирует...',
        statusBarIdle: '$(git-commit) Open Commit',
        statusBarSuccess: '$(check) Коммит сгенерирован!',
        ...
        emptyMessage: 'Open Commit вернул пустое сообщение',
        generationCancelled: 'Генерация отменена',
        gitError: 'Ошибка git: {0}',
        openCodeError: 'Ошибка OpenCode: {0}',
        openCodeCliNotFound: 'OpenCode не найден. Установите его командой: npm install -g @opencode/cli@latest',
        openCodeCliTooLargeDiff: 'Слишком большой diff. Попробуйте сделать коммит меньшими изменениями.',
        gitExtensionNotFound: 'Git extension не найдена',
        gitRepoNotFound: 'Git репозиторий не найден',
        unknownError: 'Неизвестная ошибка',
        progressTitle: 'Open Commit генерирует сообщение коммита...',
        generatingCommitMessage: 'Генерация сообщения...',
        processingMessage: 'Обработка ответа...',
        settingCommitMessage: 'Установка сообщения...',
        commitReady: 'Коммит готов!',
    ...
    en: {
        ...
        statusBarIdle: '$(git-commit) Open Commit',
        statusBarSuccess: '$(check) Commit generated!',
        ...
        emptyMessage: 'Open Commit returned empty message',
        generationCancelled: 'Generation cancelled',
        gitError: 'Git error: {0}',
        openCodeError: 'OpenCode error: {0}',
        openCodeCliNotFound: 'OpenCode not found. Install it with: npm install -g @opencode/cli@latest',
        openCodeCliTooLargeDiff: 'Diff is too large. Try committing smaller changes.',
        gitExtensionNotFound: 'Git extension not found',
        gitRepoNotFound: 'Git repository not found',
        unknownError: 'Unknown error',
        progressTitle: 'Open Commit generating commit message...',
        generatingCommitMessage: 'Generating message...',
        processingMessage: 'Processing response...',
        settingCommitMessage: 'Setting commit message...',
